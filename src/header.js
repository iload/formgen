...
function Header() {
  const html = `<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)"
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
								...
								<div id="kt_header_menu"
									...
									<ul class="menu-nav">
										...
										<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
											aria-haspopup="true">
											<a href="#" class="menu-link">
												<span class="menu-text">Car wash</span>
											</a>
										...
										<li class="navi-item">
											<a href="#" class="navi-link">
												<span class="symbol symbol-20 mr-3">
													<img src="assets/media/svg/flags/512px-Flag_of_Iran.svg.png"
														alt="" />
												</span>
												<span class="navi-text">Persian</span>
											</a>
										</li>
										<!--end::Item-->
							...
							<div class="dropdown">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto"
										...
										<span
											class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">Mehran</span>
										<span class="symbol symbol-35">
											<span
												class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">M</span>
										</span>
									</div>
								</div>
								<!--end::Toggle-->
				...
				<!--end::Header--></div>`;
  return <ReactHtml html={html} componentMap={{ Header }} />;
  // return (
  //   <nav>
